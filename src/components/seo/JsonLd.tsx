 ...
 * 目的：讓 Google / Bing 理解品牌結構 → rich results
 */
...
export function OrganizationJsonLd() {
  const data = {
    ...
    "@type": "Organization",
    "@id": "https://ime-beauty.com/#organization",
    name: "I ME",
    alternateName: ["i me", "I ME 外泌體美容", "I ME Exosome Beauty"],
    url: "https://ime-beauty.com",
    logo: {
      "@type": "ImageObject",
      url: "https://ime-beauty.com/images/42707_0.jpg",
      width: 1200,
      height: 400,
    },
    image: "https://ime-beauty.com/images/42707_0.jpg",
    description:
...
export function ServiceJsonLd() {
  const data = {
    "@context": "https://schema.org",
    "@type": "Service",
    "@id": "https://ime-beauty.com/#service",
    name: "泌容術 — 外泌體美容療程",
...
export function WebSiteJsonLd() {
  const data = {
    "@context": "https://schema.org",
    "@type": "WebSite",
    "@id": "https://ime-beauty.com/#website",
    url: "https://ime-beauty.com",
    name: "I ME — Exosome Beauty for you",
    description: "外泌體美容新美業品牌｜I ME",
    publisher: { "@id": "https://ime-beauty.com/#organization" },
    inLanguage: "zh-TW",
  };
