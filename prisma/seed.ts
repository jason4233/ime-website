...
async function main() {
  ...
  // ═══ Admin User ═══
  const adminPassword = await hash(process.env.ADMIN_PASSWORD || "ime2024admin", 12);
  ...
  console.log("  ✓ 3 founders created");
  ...
  const courses = [
    {
      ...
      fullDesc: "從外泌體科學原理到實際操作體驗，帶您了解為什麼外泌體是下一代保養革命。課程含臉部導入體驗一次。",
      durationMinutes: 90,
      price: 2999,
    ...
    },
    {
      ...
      fullDesc: "了解全球唯一iCellPro-3A1000無人化細胞製備系統、品質管控流程、與傳統GTP實驗室的差異。適合醫美從業人員進修。",
      durationMinutes: 180,
      price: 5999,
    ...
    },
    {
      ...
      fullDesc: "完整的外泌體應用技術培訓，包含臉部/身體點位實操、儀器SOP、現場演練與結業考核。通過者獲頒I ME外泌體應用結業證書。",
      durationMinutes: 300,
      price: 15000,
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      content: "做完雷射後用了外泌體凍晶，泛紅退得比以前快好多，朋友都問我是不是換了醫美診所。",
      order: 0,
    },
    {
      customerName: "陳護理師",
      ...
      rating: 5,
      content: "上完課才知道原來外泌體的製程這麼講究，有CDMO認證的跟一般的根本不能比。現在跟客人介紹更有底氣。",
      order: 1,
    },
    {
      customerName: "張太太",
      ...
      courseType: "外泌體美容入門體驗課",
      rating: 5,
      content: "用了三個月，膚況整個穩定下來了。最感動的是老公說我看起來比結婚的時候還年輕。",
      order: 2,
    },
    {
      customerName: "王美容師",
      ...
      courseType: "經銷美容師培訓認證班",
      rating: 5,
      content: "培訓很扎實，不只教技術還教怎麼跟客人溝通。拿到證書後客源明顯增加，回購率超高。",
      order: 3,
    },
    {
      customerName: "黃小姐",
      ...
      courseType: "外泌體美容入門體驗課",
      rating: 5,
      content: "以前花了好多冤枉錢在各種保養品上，直到遇到I ME才覺得：原來保養可以這麼確定。",
      order: 4,
    },
  ];
  ...
  console.log("  ✓ 10 news cards created");
  ...
  console.log("  ✓ 4 factory highlights created");
